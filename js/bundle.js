...
var FilterabelProductTable=React.createClass({displayName: "FilterabelProductTable",
    getInitialState:function(){
       return {
           filterText:'',
           inStockOnly:false
    ...
    render:function(){
        ...
        return (
           React.createElement("div", {style: tableStyle}, 
                React.createElement(SearchBar, {filterText: this.state.filterText, inStockOnly: this.state.inStockOnly, onInputChange: this.handleChange}), 
...
},{"./ProductTable.jsx":162,"./SearchBar.jsx":163,"react":158}],160:[function(require,module,exports){
var React=require('react');
...
var ProductRow=React.createClass({displayName: "ProductRow",
    render:function(){
       var stockClass= this.props.product.stocked?'stock':'';
        return (
            React.createElement("tr", null, 
                React.createElement("td", {className: stockClass}, 
...
var ProductTable=React.createClass({displayName: "ProductTable",
    render:function(){
        ...
        products.forEach(function(p,index){
            ...
            if(filterText.trim().length<1||(p.name.indexOf(filterText)>-1)){
                ...
                categoried[_category].push(
                    ...
                    React.createElement(ProductRow, {product: p, key: index})
                );
            }
        ...
        for(var key in categoried){
            ...
            rows.push(React.createElement(ProductCategoryRow, {category: key, key: key}));
...
},{"./ProductCategoryRow.jsx":160,"./ProductRow.jsx":161,"react":158}],163:[function(require,module,exports){
var React=require('react');
        ...
        render:function() {
                return (
                    React.createElement("form", null, 
                         ...
                         React.createElement("input", {type: "text", placeholder: "search...", ref: "filterText", onChange: this.handleChange, value: this.props.filterText}), 
                            React.createElement("p", null, 
                                React.createElement("input", {type: "checkbox", ref: "instockOnly", checked: this.props.inStockOnly, onChange: this.handleChange}), 
                                ' ', 
                                "Only show stocked"
                            )
                        )
...
},{"./FilterabelProductTable.jsx":159,"react":158,"react-dom":2}]},{},[164]);
